...
```{r}
training = as.matrix(read.csv("X_train.csv"))
test = as.matrix(read.csv("X_test.csv"))
trainingtarget = as.matrix(read.csv("Y_train.csv"))
...
bottleneck = c(rep(BOTTLENECK, counter-1))
metrics_df = cbind(metrics_df, bottleneck)
write.csv(metrics_df, "Task5_NN4_Result_combined4.csv", row.names = FALSE)
```


```{r}
result1 = read.csv("Task5_NN4_Result_combined1.csv")%>% drop_na()
result2 = read.csv("Task5_NN4_Result_combined2.csv")%>% drop_na()
result3 = read.csv("Task5_NN4_Result_combined3.csv")%>% drop_na()
result4 = read.csv("Task5_NN4_Result_combined4.csv")%>% drop_na()
#result5 = read.csv("Task5_NN4_Result_new200.csv")%>% drop_na()
#result6 = read.csv("Task5_NN4_Result_new500.csv")%>% drop_na()
df = rbind(result1, result2, result3, result4)
