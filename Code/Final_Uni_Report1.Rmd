...
# 5 Timeline
## 5.1 Achieved
**Week of 26 April 2021**: Id matching & batch cleaning
...
**Week of 3, 10 May 2021 (2 weeks)**: Exploration of tissues similarity and gene expression correlation in GTEx V8 
...
**Week of 17 May 2021**: Selection of tissues and sample sizes for training, validation and test sets
...
**Week of 24 May 2021**: Proposal of a number of methods and discussion of such methods
- Selecting 2 methods and defending the selected methods

**Week of 31 May 2021 - 19 July 2021**: Pause

## 5.2 Plan
**Week of 26 July, 2, 9, 16 August 2021 (4 weeks)**: Deployment of all the proposed methods in different tissues
...
**Week of 23 August 2021**: Benchmarking of the methods and selection of a final methodology
- Compare the methods against each other and describe which one should be used for the final deployment

**Week of 30 August, 6, 13 September 2021 (3 weeks)**: Deployment of the final methodology and fine tuning on validation 
- The chosen method will be deployed on all tissues and finely tuned to each tissue

**Week of 20 September 2021**: Mid semester break

**Week of 27 September 2021**: Assessment of the final methodology and the test set 
- The final tuned models will be deployed to the test sets and the final conclusion will be drawn

**Week of 4, 11 October 2021 (2 weeks)**: Exploration and description of the results
...
**Week of 18 October 2021**: Development of a user friendly algorithm
