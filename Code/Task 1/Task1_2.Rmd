...
```{r echo=FALSE}
proportion = tissue_donor_proportion[,"TMM_filt_counts_Whole Blood.Rdata"]
whole_blood_column_donor = data.frame(proportion)
whole_blood_column_donor$subtissue = as.character(file_name)
whole_blood_column_donor$tissue = as.character(tissue_names)

proportion = tissue_donor_proportion["TMM_filt_counts_Whole Blood.Rdata",]
whole_blood_row_donor = data.frame(proportion)
whole_blood_row_donor$subtissue = as.character(file_name)
whole_blood_row_donor$tissue = as.character(tissue_names)


```

```{r echo=FALSE}
proportion = shared_gene_proportion[,"TMM_filt_counts_Whole Blood.Rdata"]
whole_blood_column_gene = data.frame(proportion)
whole_blood_column_gene$subtissue = as.character(file_name)
whole_blood_column_gene$tissue = as.character(tissue_names)

proportion = shared_gene_proportion["TMM_filt_counts_Whole Blood.Rdata",]
whole_blood_row_gene = data.frame(proportion)
whole_blood_row_gene$subtissue = as.character(file_name)
whole_blood_row_gene$tissue = as.character(tissue_names)
