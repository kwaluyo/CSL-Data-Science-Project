...
This task involves the exploration of pairwise correlation between each shared gene in whole blood's gene expressions with other tissues' gene expressions. Additionally, the correlation of each gene found in Whole Blood with each tissue is also explored. Finally, the tissues are ranked on its similarity with whole blood on multiple measures.
